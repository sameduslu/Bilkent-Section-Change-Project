...
public class SchedulePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonLogin1.setBackground(new java.awt.Color(220, 172, 146));
        jButtonLogin1.setFont(new java.awt.Font("Bahnschrift", 1, 24)); // NOI18N
        jButtonLogin1.setForeground(new java.awt.Color(172, 112, 96));
        jButtonLogin1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginPage/a.png"))); // NOI18N
        jButtonLogin1.setText("SECTION CHANGE");
        jButtonLogin1.setToolTipText("");
        jButtonLogin1.setBorder(null);
        jButtonLogin1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonLogin1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        jPanel1.add(jButtonLogin1);
        jButtonLogin1.setBounds(900, 110, 250, 90);

        jButtonLogin2.setBackground(new java.awt.Color(220, 172, 146));
        jButtonLogin2.setFont(new java.awt.Font("Bahnschrift", 1, 24)); // NOI18N
        jButtonLogin2.setForeground(new java.awt.Color(172, 112, 96));
        jButtonLogin2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginPage/a.png"))); // NOI18N
        jButtonLogin2.setText("OPEN FORUM");
        jButtonLogin2.setToolTipText("");
        jButtonLogin2.setBorder(null);
        jButtonLogin2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonLogin2.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        jPanel1.add(jButtonLogin2);
        jButtonLogin2.setBounds(900, 270, 250, 90);

        jButtonLogin3.setBackground(new java.awt.Color(220, 172, 146));
        jButtonLogin3.setFont(new java.awt.Font("Bahnschrift", 1, 24)); // NOI18N
        jButtonLogin3.setForeground(new java.awt.Color(172, 112, 96));
        jButtonLogin3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginPage/a.png"))); // NOI18N
        jButtonLogin3.setText("FRIENDS");
        jButtonLogin3.setToolTipText("");
        jButtonLogin3.setBorder(null);
        jButtonLogin3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonLogin3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        jPanel1.add(jButtonLogin3);
        jButtonLogin3.setBounds(900, 430, 250, 90);
