...
public class Register implements Serializable{
    public static ObjectOutputStream myobjectOutputStream;
    ...
    private static ArrayList<Student> addStudents() {
        ...
        try{
            File database = new File("C:\\Users\\MEHMETAKAN\\Desktop\\kopya\\JavaApplication1\\src\\main\\Names_and_IDs.txt");
    ...
    {
        try {
            String retStr = json.toJson(str);
            myobjectOutputStream.writeObject(retStr);
            ...
            System.out.println("main.Register.sendString() error occured ");
            Logger.getLogger(Register.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public static void setRemain(boolean status)
    {
        remain = status;
    }
    private static Courses addCourses() {
        ...
        try{
            File database = new File("C:\\Users\\MEHMETAKAN\\Desktop\\kopya\\JavaApplication1\\src\\main\\Course_Database.txt");
            Scanner sc = new Scanner(database);
            int id = 1000;
            while(sc.hasNextLine()) {
