...
public class Register {
    ...
    private static ArrayList<Student> addStudents() {
        ...
        try {
            File database = new File("D:\\cs102\\Bilkent-Section-Change-Project\\client\\src\\main\\Names_and_IDs.txt");
    ...
    private static Courses addCourses() {
        ...
        try {
            File database = new File("D:\\cs102\\Bilkent-Section-Change-Project\\client\\src\\main\\Course_Database.txt");
            Scanner sc = new Scanner(database);
            int id = 1000;
            while (sc.hasNextLine()) {
