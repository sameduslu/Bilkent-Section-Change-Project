...
public class SchedulePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JButton jButtonOpenForum = new JButton();
        ...
        jLabel1.setFont(new java.awt.Font("PT Sans Caption", 1, 40));
        ...
        jTextField20.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField18.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField30.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField32.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField33.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField34.setFont(new java.awt.Font("PT Sans Caption", 1, 20));
        ...
        jTextField21.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField22.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField38.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField39.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField40.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField41.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField44.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField50.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jTextField81.setFont(new java.awt.Font("PT Sans Caption", 1, 14));
        ...
        jButtonSectionChange.addActionListener(this::jButtonSectionChangeActionPerformed);
        ...
        jButtonOpenForum.setFont(new java.awt.Font("Bahnschrift", 1, 24));
        jButtonOpenForum.setForeground(new java.awt.Color(172, 112, 96));
        jButtonOpenForum.setIcon(new javax.swing.ImageIcon("D:\\cs102\\Bilkent-Section-Change-Project\\JavaApplication1\\src\\main\\resources\\button.png"));
        ...
        jButtonOpenForum.addActionListener(this::jButtonOpenForumActionPerformed);
    ...
    private void jButtonSectionChangeActionPerformed(java.awt.event.ActionEvent evt) {
        SectionChangePage sPage1 = new SectionChangePage(this.student);
        sPage1.setVisible(true);
        this.dispose();
    }

    private void jButtonOpenForumActionPerformed(java.awt.event.ActionEvent evt) {
